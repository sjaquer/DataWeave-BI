...
<h3><p align="center">ä¸€æ¬¾å‚è€ƒ C++ STL å®žçŽ°çš„ JavaScript æ ‡å‡†æ•°æ®ç»“æž„åº“</p></h3>
...
- **Stack** - å…ˆè¿›åŽå‡ºçš„å †æ ˆ
- **Queue** - å…ˆè¿›å…ˆå‡ºçš„é˜Ÿåˆ—
- **PriorityQueue** - å †å®žçŽ°çš„ä¼˜å…ˆçº§é˜Ÿåˆ—
- **Vector** - å—ä¿æŠ¤çš„æ•°ç»„ï¼Œä¸èƒ½ç›´æŽ¥æ“ä½œåƒ `length` è¿™æ ·çš„å±žæ€§
- **LinkList** - éžè¿žç»­å†…å­˜åœ°å€çš„é“¾è¡¨
- **Deque** - åŒç«¯é˜Ÿåˆ—ï¼Œå‘å‰å’Œå‘åŽæ’å…¥å…ƒç´ æˆ–æŒ‰ç´¢å¼•èŽ·å–å…ƒç´ çš„æ—¶é—´å¤æ‚åº¦ä¸º O(1)
- **OrderedSet** - ç”±çº¢é»‘æ ‘å®žçŽ°çš„æŽ’åºé›†åˆ
- **OrderedMap** - ç”±çº¢é»‘æ ‘å®žçŽ°çš„æŽ’åºå­—å…¸
- **HashSet** - å‚è€ƒ [ES6 Set polyfill](https://github.com/rousan/collections-es6) å®žçŽ°çš„å“ˆå¸Œé›†åˆ
- **HashMap** - å‚è€ƒ [ES6 Set polyfill](https://github.com/rousan/collections-es6) å®žçŽ°çš„å“ˆå¸Œå­—å…¸

## âš”ï¸ åŸºå‡†æµ‹è¯•

æˆ‘ä»¬å’Œå…¶ä»–æ•°æ®ç»“æž„åº“è¿›è¡Œäº†åŸºå‡†æµ‹è¯•ï¼Œåœ¨æŸäº›åœºæ™¯æˆ‘ä»¬ç”šè‡³è¶…è¿‡äº†å½“å‰æœ€æµè¡Œçš„åº“

æŸ¥çœ‹ [benchmark](https://js-sdsl.org/#/zh-cn/test/benchmark-analyze) ä»¥èŽ·å–æ›´å¤šä¿¡æ¯
...
æ‚¨å¯ä»¥[è®¿é—®æˆ‘ä»¬çš„ä¸»é¡µ](https://js-sdsl.org/)èŽ·å–æ›´å¤šä¿¡æ¯

å¹¶ä¸”æˆ‘ä»¬æä¾›äº†å®Œæ•´çš„ [API æ–‡æ¡£](https://js-sdsl.org/js-sdsl/index.html)ä¾›æ‚¨å‚è€ƒ

æƒ³è¦æŸ¥çœ‹ä»Žå‰ç‰ˆæœ¬çš„æ–‡æ¡£ï¼Œè¯·è®¿é—®ï¼š
...
æˆ‘ä»¬ä½¿ç”¨ [karma](https://karma-runner.github.io/) å’Œ [mocha](https://mochajs.org/) æ¡†æž¶è¿›è¡Œå•å…ƒæµ‹è¯•ï¼Œå¹¶åŒæ­¥åˆ° [coveralls](https://coveralls.io/github/js-sdsl/js-sdsl) ä¸Šï¼Œä½ å¯ä»¥ä½¿ç”¨ `yarn test:unit` å‘½ä»¤æ¥é‡å»ºå®ƒ

### å¯¹äºŽæ€§èƒ½çš„æ ¡éªŒ

æˆ‘ä»¬å¯¹äºŽç¼–å†™çš„æ‰€æœ‰ API è¿›è¡Œäº†æ€§èƒ½æµ‹è¯•ï¼Œå¹¶å°†ç»“æžœåŒæ­¥åˆ°äº† [`gh-pages/performance.md`](https://github.com/js-sdsl/js-sdsl/blob/gh-pages/performance.md) ä¸­ï¼Œä½ å¯ä»¥é€šè¿‡ `yarn test:performance` å‘½ä»¤æ¥é‡çŽ°å®ƒ

æ‚¨ä¹Ÿå¯ä»¥è®¿é—®[æˆ‘ä»¬çš„ç½‘ç«™](https://js-sdsl.org/#/zh-cn/test/performance-test)æ¥èŽ·å–ç»“æžœ
...
æˆ–è€…åœ¨æœ¬åœ°ä½¿ç”¨ä»¥ä¸‹å‘½ä»¤èŽ·å–æºç è¿›è¡Œå¼€å‘ï¼š
...
ä¹‹åŽæ‚¨åœ¨ `dist/cjs` æ–‡ä»¶å¤¹ä¸­å¯ä»¥çœ‹åˆ°åœ¨ `dev` æ¨¡å¼ä¸‹æ‰“åŒ…ç”Ÿæˆçš„äº§ç‰©

## ðŸ¤ è´¡çŒ®

æˆ‘ä»¬æ¬¢è¿Žæ‰€æœ‰çš„å¼€å‘äººå‘˜æäº¤ issue æˆ– pull requestï¼Œé˜…è¯»[è´¡çŒ®è€…æŒ‡å—](https://github.com/js-sdsl/js-sdsl/blob/main/.github/CONTRIBUTING.md)å¯èƒ½ä¼šæœ‰æ‰€å¸®åŠ©

### è´¡çŒ®è€…

æ„Ÿè°¢å¯¹æœ¬é¡¹ç›®åšå‡ºè´¡çŒ®çš„å¼€å‘è€…ä»¬ï¼š
...
<table>
  <tbody>
    <tr>
      <td align="center"><a href="https://www.linkedin.com/in/takatoshi-kondo-02a91410/"><img src="https://avatars.githubusercontent.com/u/275959?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Takatoshi Kondo</b></sub></a><br /><a href="https://github.com/js-sdsl/js-sdsl/commits?author=redboltz" title="Code">ðŸ’»</a> <a href="https://github.com/js-sdsl/js-sdsl/commits?author=redboltz" title="Tests">âš ï¸</a></td>
      <td align="center"><a href="https://www.youtube.com/c/noname0310"><img src="https://avatars.githubusercontent.com/u/48761044?v=4?s=100" width="100px;" alt=""/><br /><sub><b>noname</b></sub></a><br /><a href="https://github.com/js-sdsl/js-sdsl/commits?author=noname0310" title="Code">ðŸ’»</a></td>
    </tr>
  </tbody>
</table>
...
æœ¬é¡¹ç›®éµå¾ª [all-contributors](https://github.com/all-contributors/all-contributors) è§„èŒƒã€‚ æ¬¢è¿Žä»»ä½•å½¢å¼çš„è´¡çŒ®ï¼

## â¤ï¸ èµžåŠ©è€…

ç‰¹åˆ«é¸£è°¢ä¸‹åˆ—èµžåŠ©å•†å’Œæ”¯æŒè€…ä»¬ï¼Œä»–ä»¬åœ¨éžå¸¸æ—©æœŸçš„æ—¶å€™ä¸ºæˆ‘ä»¬æä¾›äº†æ”¯æŒï¼š
...
åŒæ ·æ„Ÿè°¢è¿™äº›èµžåŠ©å•†å’Œæ”¯æŒè€…ä»¬ï¼š
